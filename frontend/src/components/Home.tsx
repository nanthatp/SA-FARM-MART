            ...
            <Paper elevation={2} sx={{ marginTop: 2 , paddingY: 1 ,marginX: 20}}>
                <Grid container padding={2}>
                    <Stack>
                        ...
                        <Grid marginBottom={2}>
                        ระบบชำระเงิน เป็นระบบที่บันทึกข้อมูลการชำระสินค้าของลูกค้า 
                        โดยพนักงานจะเป็นผู้ตรวจสอบรายการสินค้าที่ต้องชำระ 
                        แล้วป้อนจำนวนยอดรวมสุทธิ จำนวนเงินที่รับ และช่องทางการชำระเงิน เข้าระบบ 
                        </Grid>
                        <Grid marginBottom={2}>
                            <Grid>
